...
<Cards>
  <Cards.Card title="NeoGate — de voordeur voor wie hier woont" href="https://neogate.neodata.be" arrow />
  <Cards.Card title="Technisch — hosts, containers, stacks, services, runbooks" href="/technisch/hosts/" arrow />
</Cards>
